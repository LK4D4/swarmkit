...
func (a *dummyAPI) GetCluster(context.Context, *api.GetClusterRequest) (*api.GetClusterResponse, error) {
	panic("not implemented")
}

func (a *dummyAPI) ListClusters(context.Context, *api.ListClustersRequest) (*api.ListClustersResponse, error) {
	panic("not implemented")
}
